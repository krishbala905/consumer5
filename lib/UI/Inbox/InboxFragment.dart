...
//import 'package:consumer5/UI/Inbox/InboxDetails.dart';
import 'package:consumer5/UI/INBOX/Inboxmodel/InboxModel.dart';
...
class _InboxFragmentState extends State<InboxFragment> {
  ...
  void _firstLoad() async {
    ...
    print("page"+CommonUtils.consumerID.toString());
    try {
      final res =
      await http.post(Uri.parse(INBOX_URL),
          body: {
                            ...
                            children: [
                              ...
                              Row(
                                  children: [
                                    ...
                                    Expanded(
                                      child: Container(
                                        child: Image.network(posts[index].MERCHANT_URL,height: 70,),
                                      ),flex: 1,/*flex: 2,
                                      child: ClipOval(
                                          child: Container(
                                              height: 50.0,
