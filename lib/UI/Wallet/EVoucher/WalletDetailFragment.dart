...
import 'package:consumer5/UI/Wallet/Models/ParticipatingOutletmodel.dart';
import 'package:consumer5/UI/Wallet/Models/WalletViewmodel.dart';
        ...
        child: Column(
          ...
          children: [
            ...
            Padding(
              ...
              child: Text(Object1.programTitle,style: TextStyle(fontSize: 17,color: poketPurple),),
            ),
            SizedBox(
              height: 7,
            ),
            Padding(
              padding: EdgeInsets.only(left: 20),
              child: Text(expiry+ Object1.programExpiryDate,style: TextStyle(fontSize: 12),),
            ),
            SizedBox(
              height: 10,
            ),
                    ...
                    Column(
                      ...
                      children: [
                        Row(
                          ...
                          children: [
                            Expanded(
                              child: Text(object1[index].shop_name,
