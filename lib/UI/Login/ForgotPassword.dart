...
import 'package:consumer5/generated/l10n.dart';
      ...
      body: Container(
        child: Column(
          ...
          children: [
            ...
            Container(
              width: 170,
              child: Text(please_enter_your_email_address_to_reset_your_passworrd,textAlign: TextAlign.center,style:TextStyle(color: Colors.grey,fontSize: 14,)),
            ),
            SizedBox(height: 40,),
            ...
            Container(
              ...
              child: Row(
                ...
                children: [
                  Container(width:50,
                    child: Image.asset("assets/icon_email.png",height: 25, width: 25,),
                  ),
