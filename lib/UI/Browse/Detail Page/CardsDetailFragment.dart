...
import 'package:consumer5/UI/Browse/CardPurchaseFragment.dart';
import 'package:consumer5/UI/Browse/Detail%20Page/BrowseCardDetailModel.dart';
...
class CardsDetailFragment extends StatefulWidget {
  ...
  final String currencylist;
  final String programname;
  final String programimage;
  final String emailid;
  final String phoneno;
  const CardsDetailFragment(
      {Key? key,
  ...
  @override
  State<CardsDetailFragment> createState() => _CardsDetailFragmentState(
      this.MerchantId,
      this.Programid,
      this.CurrentPrice,
      this.OriginalPrice,
...
class _CardsDetailFragmentState extends State<CardsDetailFragment> {
  String MerchantId;
  String Programid;
  String CurrentPrice;
  ...
  @override
  void initState() {
    print(Programid.toString());
    print("p10" + CurrentPrice.toString());
    print(OriginalPrice.toString());
    print(downloadflag.toString());
    // getEcardData();
    super.initState();
  }

  var BenifitVisible = true;
  var rewardVisible = true;
  var TncVisible = true;
  ...
  Widget build(BuildContext context) {
    return SafeArea(
        ...
        child: Scaffold(
            appBar: AppBar(
              title: Text("MBM Wheelpower"),
              backgroundColor: Maincolor,
              centerTitle: true,
            ),
            body: Column(
              children: [
                Expanded(flex: 11, child: LoadDetailPage(context)),
                Expanded(
                    flex: 2,
                    child: Padding(
                      padding:
                      ...
                      child: Column(
                        ...
                        /*  Row(
                          ...
                          Text(
                            CurrentPrice == "Free"
                                ? "Free"
                                : currencylist + " " + OriginalPrice.toString(),
                            style: TextStyle(color: poketpurple),
                          ),
                          SizedBox(
                            height: 6,
                          ),
                          OriginalPrice == "Free"
                              ? CurrentPrice == "Free" && downloadflag == "1"
                                  ? Container(
                                      height: 30,
                                  ...
                                  : InkWell(
                                      onTap: () {
                                        showAlertForGetit(
                                            Programid, programtype, outletid);
                                      },
                                      child: Container(
                                          height: 30,
                              ...
                              : CurrentPrice == "UPGRADE" && downloadflag == "0"
                                  ? InkWell(
                                      onTap: () {
                                        Navigator.push(
                                            context,
  ...
  Widget Singlechildsrollwidget(
      BuildContext context, List<BrowseCardDetailModel> Object) {
    print("chck" + Object[0].programImageURLs[0].toString());
    print("chck" + Object[0].merchantLogoURL[0].toString());
    List rew = Object[0].rewards;
    print("chck" + rew.length.toString());
    print("chck" + rew[0].toString());
    var merchantinfor = Object[0].merchantinfo.toString().replaceAll("\\n", "\n");
    merchantinfor = merchantinfor.replaceAll("\\", "");
    var tncc = Object[0].tnc.toString().replaceAll("<br>", "\n");
    tncc = tncc.replaceAll("â¢", "*");
    var bene = Object[0].benefits.toString().replaceAll("<br>", "\n");
    bene = bene.replaceAll("â¢", "*");
    return Column(
        ...
        Container(
          ...
          child: Stack(
            children: [
              Center(
                  child: Image.network(
                   // "https://mbmdev.poket.com/main/merchant_images/mbm/1/merchant_card/card_image/79/1_79_1.jpg",
                Object[0].programImageURLs[0].toString(),
                height: 180,
                width: 220,
                fit: BoxFit.fitWidth,
              )),
...
/*Widget ParticipatingOutlet(BuildContext context,List<OutletDatum> OutletData ) {
  ...
  Future<List<BrowseCardDetailModel>> getEcardData() async {
    ...
    if (response.statusCode == 200) {
     ...
     // String tnc = p4.split("*")[0].toString();
  ...
  void showAlertForGetit(var programId, var programtype, var outletid) {
    AlertDialog alert1 = AlertDialog(
      ...
      content: Padding(
        ...
        child: Text(
            "By accepting this card, you agree to join MBM Wheelpower Pte Ltd loyalty program and share your profile information to them.",
            textAlign: TextAlign.left,
